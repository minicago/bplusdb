...
int BPlusTreePage::GetMinSize() const {
  ...
  return IsLeafPage()?(max_size_-1+1)/2:(max_size_-1-1+1)/2+1;
}
...
void BPlusTreePage::SetParentPageId(page_id_t parent_page_id) { parent_page_id_ = parent_page_id; return; }
